  ...
  return (
    <TitledDashboardPanel title="Activity Monitor" panelId="activity-monitor" contentFlush>
      <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-y-auto">
        <div
          className="relative grid min-h-0 w-full shrink-0 place-items-center overflow-hidden"
          style={{ minHeight: 180 }}
        >
          <img
        ...
        {!epochOk ? (
          ...
          <div className="flex min-h-0 w-full min-w-0 flex-1 flex-col overflow-y-auto px-4 pb-4 pr-3 text-left">
